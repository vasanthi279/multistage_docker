    ...
    stages {
        stage('Build') {
            steps {
               ...
               sh "sudo docker tag dumy:latest 315073111691.dkr.ecr.ap-south-1.amazonaws.com/dumy:latest"
               sh "sudo docker push 315073111691.dkr.ecr.ap-south-1.amazonaws.com/dumy:latest"
